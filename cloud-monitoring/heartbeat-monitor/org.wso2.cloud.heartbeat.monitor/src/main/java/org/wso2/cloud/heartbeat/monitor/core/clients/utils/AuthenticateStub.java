...
/**
 *  Stub authentication utilities implemented in this class
 */
public class AuthenticateStub {
    ...
    /**
     * Authenticate the given web service stub against the Product user manager. This will make it
     * possible to use the stub for invoking Product admin services.
