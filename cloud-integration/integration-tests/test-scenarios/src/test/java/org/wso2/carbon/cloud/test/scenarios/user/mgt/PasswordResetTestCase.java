...
public class PasswordResetTestCase extends CloudIntegrationTest {
    ...
    @Test(description = "Password Reset Test for User") public void resetPasswordTest() throws Exception {
        ...
        params.put(CloudIntegrationConstants.EMAIL, email);
        ...
        //The confirmation key used in the initiatePasswordReset cannot be acceed in the test suite.
        //Therefore, a new key is generated by calling UserInformationRecoveryService
        ...
        sendNotificationBean = recoveryServiceClient
                .sendRecoveryNotification(domainLessUserName, verificationBean.getKey(),
                        CloudIntegrationConstants.EMAIL);
