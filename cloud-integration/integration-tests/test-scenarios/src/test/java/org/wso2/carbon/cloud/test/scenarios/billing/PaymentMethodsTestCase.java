...
public class PaymentMethodsTestCase extends CloudIntegrationTest {
    ...
    public void setEnvironment() throws Exception {
        authenticatorClient = new JaggeryAppAuthenticatorClient(cloudMgtServerUrl, CloudConstants.CLOUD_MGT_APP);
    ...
    public void addPaymentMethod() throws Exception {
        String serviceId = CloudIntegrationTestUtils.getPropertyValue(CloudConstants.BILLING_PAYMENT_SERVICE_ID);
        String productPlanId = CloudIntegrationTestUtils
                .getPropertyValue(CloudConstants.BILLING_PAYMENT_PRODUCT_RATE_PLAN_ID);
        ...
        String paymentMethodAddUrl = cloudMgtServerUrl + CloudConstants.CLOUD_BILLING_PAYMENT_METHOD_ADD_URL_SFX;
    ...
    public void viewPaymentMethods() throws Exception {
        ...
        String paymentMethodInfoUrl = cloudMgtServerUrl + CloudConstants.CLOUD_BILLING_PAYMENT_METHOD_INFO_URL_SFX;
