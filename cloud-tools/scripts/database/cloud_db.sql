...
CREATE TABLE RIGHTWAVE_CLOUD_SUBSCRIPTION (
  ...
  INTEGRATION_CLOUD TINYINT(1) NOT NULL DEFAULT 0,
  API_CLOUD TINYINT(1) NOT NULL DEFAULT 0,
  DEVICE_CLOUD TINYINT(1) NOT NULL DEFAULT 0,
  IDENTITY_CLOUD TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS MONETIZATION_PRODUCT_PLANS (
  ...
  RATE_PLAN_ID VARCHAR(255) NOT NULL UNIQUE,
  PRIMARY KEY(TENANT_DOMAIN, PRODUCT_NAME, RATE_PLAN_NAME)
);
