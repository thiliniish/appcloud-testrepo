...
CREATE TABLE IF NOT EXISTS MONETIZATION_PRODUCT_PLANS (
 ...
 OVER_USAGE VARCHAR(50) NOT NULL,
 PRIMARY KEY(TENANT_DOMAIN, RATE_PLAN_ID)
);

CREATE TABLE IF NOT EXISTS MONETIZATION_SUBSCRIBERS (
...
CREATE TABLE IF NOT EXISTS MONETIZATION_SUBSCRIPTIONS (
 ...
 START_DATE DATETIME NOT NULL,
 PRIMARY KEY(ACCOUNT_NUMBER, AM_APP_NAME, AM_API_NAME)
);

CREATE TABLE IF NOT EXISTS MONETIZATION_SUBSCRIPTIONS_HISTORY (
 ACCOUNT_NUMBER VARCHAR(50) NOT NULL,
 AM_APP_NAME VARCHAR(255) NOT NULL,
 AM_API_NAME VARCHAR(255) NOT NULL,
 RATE_PLAN_ID VARCHAR(32) NOT NULL,
 ...
 START_DATE DATETIME NOT NULL,
 END_DATE DATETIME NOT NULL,
 PRIMARY KEY(ACCOUNT_NUMBER, AM_APP_NAME, AM_API_NAME, START_DATE)
);