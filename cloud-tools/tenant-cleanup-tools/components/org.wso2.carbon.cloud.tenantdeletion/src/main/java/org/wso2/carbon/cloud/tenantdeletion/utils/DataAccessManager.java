...
public class DataAccessManager {
    ...
    public void insertUserLoginInfo(int id, String domainName, String currentDate) {
        ...
        try {
            ...
            connection = DataConnectionManager.getInstance().getCloudMgtDbConnection();
            if (connection != null) {
    ...
    public List<Integer> getAllInactiveTenantIdList() {
        ...
        try {
            statement = DataConnectionManager.getInstance().getCloudMgtDbConnection().createStatement();
    ...
    public boolean isPaidTenant(String tenantDomain) {
        ...
        try {
            ...
            statement = DataConnectionManager.getInstance().getCloudMgtDbConnection().prepareStatement(query);
    ...
    public void raiseDeletionFlag(String type, String tenantDomain, int deletionStatus) {
        ...
        try {
            ...
            if (columnName != null) {
                ...
                preparedStatement =
                        DataConnectionManager.getInstance().getCloudMgtDbConnection().prepareStatement(query);
