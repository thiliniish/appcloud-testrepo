...
public class DeletionQueries {
    ...
    public static final String QUERY_INSERT_USER_LOGIN_INFO = "INSERT INTO " + USER_LOGIN +
                                                              " (TENANT_ID, TENANT_DOMAIN, LAST_LOGIN_DATE) VALUES " +
                                                              "(?, ?, ?) ON DUPLICATE KEY UPDATE LAST_LOGIN_DATE =" +
                                                              " ? ";
    ...
    public static final String QUERY_INSERT_DELETE_TENANT_INFO = "INSERT INTO " + DELETION_TENANTS +
                                                                 " (TENANT_ID, TENANT_DOMAIN) VALUES (?,?) ON " +
                                                                 "DUPLICATE KEY UPDATE TENANT_ID = ? ";
    ...
    public static final String QUERY_REMOVE_TENANTS_FROM_DELETE_LIST_WITH_DOMAIN =
