...
(*) Dependencies to compile and build components -
	...
	(2.) Oracle JDK 1.6. 
	(3.) Need to compile and build the patch0004 of Carbon Kernel 4.2.0 patches prior compiling any
             of WSO2 Cloud components. ( svn location : https://svn.wso2.org/repos/wso2/carbon/kernel/branches/4.2.0/patches )

(*) Compile and build from the root pom.xml in the initial attempt.  
