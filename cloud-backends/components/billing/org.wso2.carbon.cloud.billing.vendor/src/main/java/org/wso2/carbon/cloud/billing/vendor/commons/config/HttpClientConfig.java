...
@XmlRootElement(name = "HttpClientConfig") public class HttpClientConfig {
    ...
    @XmlElement(name = "Hostname", required = false) public String getHostname() {
        return hostname;
    }
    ...
    @XmlElement(name = "Port", required = false) public int getPort() {
        return port;
    }
    ...
    @XmlElement(name = "MaxTotalConnections", nillable = false, required = true) public int getMaxTotalConnections() {
