...
/**
 * Model to represent Utilities for Cloud billing vendor service
 */
public class CloudBillingVendorUtils {
     ...
     */
    public static String validateResponseString(String response) {
