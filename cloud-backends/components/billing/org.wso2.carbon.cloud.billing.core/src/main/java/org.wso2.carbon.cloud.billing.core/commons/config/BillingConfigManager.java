...
/**
 * This class manages the Billing Configurations
 */
public class BillingConfigManager {

    private static final Log LOGGER = LogFactory.getLog(BillingConfigManager.class);

    private static volatile BillingConfig billingConfig = null;
    ...
    /**
     * Initializes the full configuration as {@link BillingConfig}
     */
    private static void initialize() throws CloudBillingException {
        synchronized (BillingConfigManager.class) {
            if (billingConfig == null) {
                LOGGER.info("Loading billing Configuration.");
    ...
    /**
     * Returns the whole configuration as a {@link BillingConfig} bean
     *
     * @return BillingConfiguration bean
     */
    public static BillingConfig getBillingConfiguration() {
        try {
            ...
            LOGGER.fatal("Error occurred while initializing billing configuration.", e);
        }
    ...
    private static BillingConfig loadBillingConfig() throws CloudBillingException {
        try {
            ...
            throw new CloudBillingException("Error occurred while initializing Billing config", e);
        }
    }
