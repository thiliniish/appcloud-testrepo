...
public class WSO2CloudUserStoreManager extends CloudUserStoreManager {
     ...
     * @throws UserStoreException
     */
    public String[] doConvertUserList(String[] users) throws UserStoreException {
    ...
    public String doConvertUserNameToEmail(String userName) throws UserStoreException {
