...
public class CloudConstants {
    ...
    //Data Publishing to BAM related constants
    public static final String  TENANT_USER_STREAM = "org.wso2.carbon.cloud.tenantUser";
    public static final String APP_USER_STREAM = "org.wso2.carbon.cloud.appUser";
    public static final String TENANT_USER_STREAM_VERSION = "1.0.0";
    public static final String APP_USER_STREAM_VERSION = "1.0.0";
