...
<head>
    ...
    <link
            href='http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic,700italic'
                    ...
                    <div class="login-box">
                        <div class="login-box-top">
                            <div class="login-box-top-inside">
                                <h2 class="login-sub-title"><p><%=app%></p>
                                    requests access to clone your source code</h2>
